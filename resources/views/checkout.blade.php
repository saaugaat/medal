    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-8 ftco-animate">
                ...
                <form action="/placeorder" class="billing-form" method="POST">
                    @csrf
              ...
              <div class="w-100"></div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                    <input type="text" class="form-control" placeholder="Appartment, suite, unit etc: (optional)" name="addressop">
                  </div>
                  </div>
                  <div class="w-100"></div>
                  <div class="col-md-6">
              ...
              <input type="submit" class="btn btn-secondary py-3 px-4" value="Place an order">
            </form><!-- END -->
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><span class="icon icon-map-marker"></span><span class="text">tahachal, Kathmandu</span></li>
                  <li><a href="#"><span class="icon icon-phone"></span><span class="text">+9779860419614</span></a></li>
